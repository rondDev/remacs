...
Functionality in Rmcs is divided into collections of code called modules (à la
...
removing them from your ~rmcs!~ block in =$RMCSDIR/init.el=.
...
+ [[file:../modules/config/literate/README.org][literate]] - For users with literate configs. This will tangle+compile a
  config.org in your ~rmcs-private-dir~ when it changes.
...
+ [[file:../modules/ui/rmcs/README.org][rmcs]] - TODO
+ [[file:../modules/ui/rmcs-dashboard/README.org][rmcs-dashboard]] - TODO
+ [[file:../modules/ui/rmcs-quit/README.org][rmcs-quit]] - TODO
