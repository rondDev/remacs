...
- +icons ::
  ...
  [[rmcs-package:nerd-icons]] or [[rmcs-package:treemacs]] iconsets.

** Packages
- [[rmcs-package:helm]]
- [[rmcs-package:helm-company]]
- [[rmcs-package:helm-c-yasnippet]]
- [[rmcs-package:helm-descbinds]]
- [[rmcs-package:helm-describe-modes]]
- [[rmcs-package:helm-flx]]* if [[rmcs-module:+fuzzy]]
- [[rmcs-package:helm-icons]]* if [[rmcs-module:+icons]]
- [[rmcs-package:helm-org]]* if [[rmcs-module::lang org]]
- [[rmcs-package:helm-posframe]]* if [[rmcs-module:+childframe]]
- [[rmcs-package:helm-projectile]]
- [[rmcs-package:helm-rg]]
- [[rmcs-package:helm-swiper]]
...
* TODO Usage
Much like [[rmcs-package:ivy]] and [[rmcs-package:vertico]], [[rmcs-package:helm]] is a /large/ framework. Covering
...
Changes to the resulting [[rmcs-package:wgrep]] buffer (opened by [[kbd:][C-c C-e]]) can be
committed with [[kbd:][C-c C-c]] and aborted with [[kbd:][C-c C-k]] (alternatively [[kbd:][ZZ]] and [[kbd:][ZQ]], for
evil users).

** In-buffer searching
The [[rmcs-package:swiper]] package provides an interactive buffer search powered by helm. It can
be invoked with:
...
A [[rmcs-package:wgrep]] buffer can be opened from swiper with [[kbd:][C-c C-e]].
...
[[rmcs-package:nerd-icons]] and [[rmcs-package:treemacs]]. By default, and to
maintain consistency with other icons across Rmcs's modules,
[[rmcs-package:nerd-icons]] is used. To change this:
#+begin_src emacs-lisp
;; add to $RMCSDIR/config.el
(after! helm
