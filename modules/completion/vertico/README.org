...
** Packages
- [[rmcs-package:nerd-icons-completion]] if [[rmcs-module:+icons]]
- [[rmcs-package:consult]]
- [[rmcs-package:consult-flycheck]] if [[rmcs-module::checkers syntax]]
- [[rmcs-package:embark]]
- [[rmcs-package:embark-consult]]
- [[rmcs-package:marginalia]]
- [[rmcs-package:orderless]]
- [[rmcs-package:vertico]]
- [[rmcs-package:vertico-posframe]] if [[rmcs-module:+childframe]]
- [[rmcs-package:wgrep]]
...
rmcs doctor~ to determine if your build meets this requirement), which is a hard
dependency of Rmcs itself, so you should already have it installed.
...
Rmcs-specific additions:

** Vertico keybindings
When in an active Vertico completion session, the following rmcs added
...
[[rmcs-package:projectile]]:

https://assets.rmcsemacs.org/completion/vertico/projectile.png
...
https://assets.rmcsemacs.org/completion/vertico/search.png
...
(alternatively [[kbd:][ZZ]] and [[kbd:][ZQ]], for evil users). It uses [[rmcs-package:wgrep]] for grep searches,
[[rmcs-package:wdired]] for file searches, and =occur= for buffer searches.

https://assets.rmcsemacs.org/completion/vertico/search-replace.png
...
https://assets.rmcsemacs.org/completion/vertico/buffer-search.png
...
filtered with Emacs instead (and can be filtered using [[rmcs-package:orderless]], for example).
...
Rmcs has some builtin [[https://github.com/oantolin/orderless#style-dispatchers][style dispatchers]] for more fine-grained filtering, which
