...
** Packages
- [[rmcs-package:calfw]]
- [[rmcs-package:calfw-org]]
- [[rmcs-package:org-gcal]]
...
- [[https://github.com/kidd/org-gcal.el#installation][An OAuth client ID]], for syncing said account with [[rmcs-package:org-gcal]].
