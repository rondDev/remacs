...
** Module flags
- +org ::
  Enable [[rmcs-package:elfeed-org]], so you can configure your feeds with an org file
  (={org-directory}/elfeed.org=) rather than Elisp.

** Packages
- [[rmcs-package:elfeed]]
- [[rmcs-package:elfeed-goodies]]
- [[rmcs-package:elfeed-org]] if [[rmcs-module:+org]]
...
subscriptions in =$RMCSDIR/config.el=:
#+begin_src emacs-lisp
(setq elfeed-feeds
