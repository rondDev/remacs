...
(use-package! doom-modeline
  ...
  :hook (rmcs-after-init . doom-modeline-mode)
  ...
  (add-hook 'rmcs-load-theme-hook #'doom-modeline-refresh-bars)

  (add-to-list 'doom-modeline-mode-alist '(+rmcs-dashboard-mode . dashboard))
