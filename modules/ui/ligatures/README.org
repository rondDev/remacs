...
- A patched font for Rmcs's fallback ligature support.
...
necessary on Rmcs side; otherwise, Rmcs uses the [[https://github.com/mickeynp/ligature.el][ligature.el]] package that
