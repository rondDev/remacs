...
- +flyspell ::
  Use [[rmcs-package:flyspell]] instead of [[rmcs-package:spell-fu]]. It's significantly slower, but supports
  multiple languages and dictionaries.
- +hunspell ::
  Use =hunspell= as a backend for correcting words.

** Packages
- if [[rmcs-module:+flyspell]]
  - [[rmcs-package:flyspell-correct]]
  - [[rmcs-package:flyspell-correct-ivy]] if [[rmcs-module::completion ivy]]
  - [[rmcs-package:flyspell-correct-helm]] if [[rmcs-module::completion helm]]
  - [[rmcs-package:flyspell-correct-popup]] unless [[rmcs-module::completion ivy]], [[rmcs-module::completion helm]], or
    [[rmcs-module::completion vertico]]
  - [[rmcs-package:flyspell-lazy]]
- else
  - [[rmcs-package:spell-fu]]
...
#+begin_quote
  If you *are not* using [[rmcs-module:+flyspell]], you will need =aspell= (and a dictionary)
    installed whether or not you have [[rmcs-module:+hunspell]] or [[rmcs-module:+enchant]] enabled. This is
    because [[rmcs-package:spell-fu]] does not support generating the word list with anything
...
When using [[rmcs-module:+everywhere]], spell checking is performed for as many major modes as
...
*** Flyspell users
Lazy spellcheck is provided by [[rmcs-package:flyspell-lazy]] package.
...
respectively. [[rmcs-module:+flyspell]] users can also add/remove words from the
[[rmcs-package:flyspell-correct]] popup interface (there will be extra options on the list of
...
[[rmcs-package:spell-fu]] caches its word list. If it was activated before your dictionaries were
