...
documentation of their respective [[rmcs-module::lang]] module for instructions.
...
REPLs are defined for most languages Rmcs supports. Check that language module's
...
will bar you from the benefits of Rmcs's REPL system (like send-to-repl
functionality).
#+end_quote
