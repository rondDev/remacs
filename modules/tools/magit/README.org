...
** Packages
- [[rmcs-package:evil-magit]] if [[rmcs-module::editor evil +everywhere]]
- [[rmcs-package:forge]] if [[rmcs-module:+forge]]
- [[rmcs-package:code-review]] if [[rmcs-module:+forge]]
- [[rmcs-package:magit]]
- [[rmcs-package:magit-todos]]

** Hacks
- [[rmcs-package:magit]] has been modified to recognize =$XDG_CACHE_HOME/git/credential/socket=.
- [[rmcs-package:magit]] has been modified to invalidate the projectile cache when you check out
  a new branch or commit.
- [[rmcs-package:magit]] has been modified to revert repo buffers (e.g. after changing branches)
  when you later switch to them, rather than all at once.
- [[rmcs-package:forge]] was modified to defer compilation of emacsql-sqlite until you try to use
...
- [[rmcs-module:+forge]] requires [[https://magit.vc/manual/forge/Token-Creation.html#Token-Creation][a Github API token]]
- [[rmcs-package:code-review]] will also require a token setup (see [[https://github.com/wandersoncferreira/code-review#configuration][configuration]] for your particular forge)
