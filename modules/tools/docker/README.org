...
** Packages
- [[rmcs-package:docker]]
- [[rmcs-package:docker-tramp]]
- [[rmcs-package:dockerfile-mode]]
...
- =dockfmt= for [[rmcs-module::editor format]]: https://github.com/jessfraz/dockfmt#installation
...
~load-path~ somewhere and add the following to =$RMCSDIR/config.el= to overwrite
