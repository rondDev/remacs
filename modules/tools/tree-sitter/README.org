...
* Description :unfold:
This module adds [[https://tree-sitter.github.io/tree-sitter/][tree-sitter]] support to Rmcs Emacs.
...
** Packages
- [[rmcs-package:evil-textobj-tree-sitter]] if [[rmcs-module::editor evil +everywhere]]
- [[rmcs-package:tree-sitter]]
- [[rmcs-package:tree-sitter-langs]]
...
fulfill before tree-sitter support works for them. Run ~$ rmcs doctor~ to find
...
flag to their respective Rmcs modules. Check the module readme of your language
for support.
