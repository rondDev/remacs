...
** Module flags
- +manual ::
  Don't activate [[rmcs-package:objed]] at startup, automatically, leaving it to the user to call
  [[fn:objed-activate]] (bound to [[kbd:][M-SPC]] if using [[rmcs-module::config default +bindings]]).
...
#+begin_quote
  This module is incompatible with [[rmcs-module::editor evil]]. Do not enable them both at
