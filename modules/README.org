...
#+subtitle: Rmcs Emacs' official module repository
#+startup:  nonum

* Description :unfold:
This is a repository of official modules for [[https://github.com/rmcsemacs/core][Rmcs Emacs]]. They are more closely
looked after by Rmcs's author. If a module you want isn't here, check our
...
#+begin_quote
 📌 Technical documentation on the anatomy of Rmcs modules can be found in [[id:72d8e438-a224-421a-b6a9-43d7dcebe0bb][the
...
* Installation
This module repository is included with Rmcs Emacs (for now). No additional
...
This module provides code completion, powered by [[https://github.com/company-mode/company-mode][company-mode]]. Many of Rmcs's
...
This module adds text rotation to Rmcs Emacs. I.e. The ability to cycle through
...
This module provides barebones support for using Rmcs with non-qwerty keyboard
layouts.
...
This module adds [[https://fsharp.org/][F#]] support to Rmcs Emacs.
...
This module adds support for the [[https://leanprover.github.io/about/][Lean programming language]] to Rmcs Emacs.
...
This module adds support for the Nix language to Rmcs Emacs, along with tools
...
This module adds support for PHP 5.3+ (including PHP7) to Rmcs Emacs.
...
This module adds [[https://www.purescript.org/][Purescript]] support to Rmcs Emacs.
...
This module adds support for the [[https://www.raku.org/][Raku programming language]] to Rmcs Emacs.
...
This module adds [[https://www.scala-lang.org][scala]] and [[https://www.scala-sbt.org/][sbt]] support to Rmcs Emacs.
...
This module provides support for the [[https://yaml.org/][YAML file format]] to Rmcs Emacs.
...
This module integrates [[rmcs-package:taskrunner]] into Rmcs Emacs, which scraps runnable tasks
...
This module adds hydra to Rmcs Emacs, as well as a few custom built hydras to
start with:
...
This module extends Rmcs's ability to display non-English unicode. It is
primarily useful for non-English Emacs users, for whom Rmcs's built-in unicode
