...
- Linting (~clj-kondo~), requires [[rmcs-module::checkers syntax]]
- LSP support (~clojure-lsp~), required [[rmcs-module:+lsp]]
...
** Module flags
- +lsp ::
  Enable LSP support for ~clojure-mode~ (alongside Cider). Requires [[rmcs-module::tools lsp]]
...
** Packages
- [[rmcs-package:cider]]
- [[rmcs-package:clj-refactor]]
- [[rmcs-package:flycheck-clj-kondo]] if [[rmcs-module::checkers syntax]]
...
- [[https://github.com/borkdude/clj-kondo][clj-kondo]], for linting code (if [[rmcs-module::checkers syntax]])
- [[https://clojure-lsp.github.io/clojure-lsp/][clojure-lsp]], for LSP support (if [[rmcs-module:+lsp]])
...
- [[https://github.com/weavejester/cljfmt][cljfmt]], for formatting code (if [[rmcs-module::editor format]])
...
** Search/navigation
Some useful bindings for navigating around namespaces and symbols. When using [[rmcs-module:+lsp]], the bindings in [[rmcs-module::tools lsp]] are supported.
