...
** Packages
- [[rmcs-package:sly]]
- [[rmcs-package:sly-macrostep]]
- [[rmcs-package:sly-repl-ansi-color]]
...
This module does not integrate with [[rmcs-module::tools lsp]]. Sly (and SLIME before it) is
...
** formatter
By enabling [[rmcs-module::editor format]], [[fn:apheleia-indent-lisp-buffer]] will be
