...
* Description :unfold:
This module adds [[https://www.graphql.org][GraphQL]] support to Rmcs Emacs.

It includes:
- Code completion
- LSP support ([[rmcs-module:+lsp]])
...
- Local schema viewer
- Org-babel exporter (requires [[rmcs-module::lang org]])
...
** Module flags
- +lsp ::
  Enable LSP support for ~graphql-mode~. Requires [[rmcs-module::tools lsp]] and a langserver
  ([[https://github.com/graphql/graphiql/tree/main/packages/graphql-language-service-cli#readme][graphql-language-service-cli]]).

** Packages
- [[rmcs-package:company-graphql]] unless [[rmcs-module:+lsp]]
- [[rmcs-package:graphql-mode]]
- [[rmcs-package:graphql-doc]]
