...
- +lsp ::
  Enable an LSP hook for ~nix-mode~. Requires [[rmcs-module::tools lsp]] and a language
...
** Packages
- [[rmcs-package:company-nixos-options]] if [[rmcs-module::completion company]]
- [[rmcs-package:helm-nixos-options]] if [[rmcs-module::completion helm]]
- [[rmcs-package:nix-mode]]
- [[rmcs-package:nix-update]]
...
- [[https://nixos.org/guides/install-nix.html][The Nix package manager]], for a variety of its features (besides syntax
  highlighting).
- =nixfmt=, for automatic formatting (requires [[rmcs-module::editor format]]).
