...
** Module flags
- +lsp ::
  Enable LSP support for ~scala-mode~. Requires [[rmcs-module::tools lsp]] and a langserver
  (supports metals).
- +tree-sitter ::
...
** Packages
- [[rmcs-package:sbt-mode]]
- [[rmcs-package:scala-mode]]
- [[rmcs-package:lsp-metals]] if [[rmcs-module:+lsp]]
...
Formatting is handled using the [[rmcs-module::editor format]] module via [[https://scalameta.org/scalafmt/docs/installation.html#cli][scalafmt]].
