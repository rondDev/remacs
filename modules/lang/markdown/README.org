...
** Packages
- [[rmcs-package:edit-indirect]]
- [[rmcs-package:evil-markdown]] if [[rmcs-module::editor evil +everywhere]]
- [[rmcs-package:grip-mode]] if [[rmcs-module:+grip]]
- [[rmcs-package:markdown-mode]]
- [[rmcs-package:markdown-toc]]

** Hacks
- [[rmcs-package:flyspell]] has been configured not to spell check in code blocks, links, HTML
  tags or references.
...
- A linter (requires [[rmcs-module::checkers syntax]])
...
Alternatively, you can use ~grip-mode~ through [[rmcs-module:+grip]].
