...
- rustic has been modified /not/ to automatically install lsp-mode or eglot if
  they're missing. Rmcs expects you to have enabled the [[rmcs-module::tools lsp]] module
  yourself.
...
#+begin_quote
 󰐃 Once installed, I recommended that you add Cargo's executable to your
    ...
    won't be visible to Rmcs until you run it (or ~$ rmcs sync~) again.
#+end_quote
...
Finally, enable Rmcs's [[rmcs-module::tools lsp]] module, and this module's
...
Rmcs's [[rmcs-module::tools lsp]] module has an [[rmcs-module:+eglot]] flag. Enable it and this module will use
eglot instead.
