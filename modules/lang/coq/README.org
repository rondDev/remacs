...
** Packages
- [[rmcs-package:proof-general]]
- [[rmcs-package:company-coq]]

** Hacks
+ Replaces coq-mode abbrevs with yasnippet snippets from rmcs's snippet library
...
* Troubleshooting
See [[https://github.com/hlissner/rmcs-emacs/issues?q=is%3Aissue+is%3Aopen+label%3A%22%3Alang+coq"][related github issues]]
