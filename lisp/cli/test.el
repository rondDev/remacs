...
;;; Commentary:
;;
;; The heart of Rmcs's test DSL and framework. Powered by either ERT or
...
;; integration with Rmcs's profiles system so testing environments can be
...
;; TODO Implement me
(defvar rmcs-test-backend 'ert
  "One of `ert' or `buttercup'.")

;; TODO Implement me
(defvar rmcs-test-isolation-level nil
