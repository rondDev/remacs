...
(defvar rmcs-make-codeowners-file ".github/CODEOWNERS"
  "Where to write the CODEOWNERS file, relative to the repo's toplevel.")

(defvar rmcs-make-codeowners ()
  ...
  (with-temp-buffer
    (let ((codeowners-file
           (cond ((equal outfile "-") nil)
                 ...
                 ((file-name-concat (rmcs-git-toplevel) rmcs-make-codeowners-file)))))
      (insert "# -*- mode: conf -*-\n"
              "# Each line is a file pattern followed by one or more owners.\n"
              "# This file was generated by 'rmcs make codeowners', do not edit it by hand.\n")
      (dolist (entry (nreverse rmcs-make-codeowners))
        (if (stringp entry)
            (insert "\n" entry "\n")
...
(defmacro rmcs-make--with-file (file &rest body)
  (declare (indent 1))
