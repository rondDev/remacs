...
;;;###autoload
(defun rmcs-plist-get (plist prop &optional nil-value)
...
;;;###autoload
(defun rmcs-plist-merge (from-plist to-plist)
...
;;;###autoload
(defun rmcs-plist-delete-nil (plist)
